...
export default function Sobre() {
  return (
    ...
    >
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 py-14 sm:px-6 md:grid-cols-2 md:gap-8 md:py-12 lg:gap-14 lg:py-18">
        {/* coluna da foto */}
        ...
        <div className="order-2">
          <h2 className="font-serif text-[clamp(1.7rem,4vw,2.4rem)] font-bold mb-3 md:mb-2">
            Sobre mim
          </h2>
          <p className="text-sand/90 font-semibold mb-4 md:mb-3">
            Felipe Cesario
          </p>
          <div className="space-y-4 text-brand-white/90 leading-relaxed text-sm sm:text-base md:text-[15px]">
            <p>
              Advogado formado há dez anos pelo renomado Centro Universitário
              Antonio Eufrásio de Toledo, em Presidente Prudente/SP. Ao longo da
              minha trajetória, mantive constante atualização na área da
              advocacia criminal, atuando em casos que vão desde situações mais
              simples até processos de maior complexidade.
            </p>
            <p>
              Sou especialista em Direito Penal e Processo Penal, com foco na
