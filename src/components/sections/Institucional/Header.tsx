...
export default function Header() {
  ...
  // Novo: CTA WhatsApp (mantendo apenas mudança visual/UX)
  ...
  // MANTEVE o comportamento do seu header original
  const handleConsultoriaClick = useCallback((e: React.MouseEvent<HTMLAnchorElement>) => {
    ...
    // 1) tentar rolar no documento atual
    ...
    // 2) fallback: deixa o Next/Link processar o href
  }, [pushDL]);
      ...
      <div className="mx-auto max-w-7xl px-3 sm:px-4 md:px-6 py-6">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            {/* Ligar — agora botão vermelho cheio */}
            <a
              href={telHref}
            ...
            {/* Consultoria Jurídica — MANTEVE o mesmo href/handler; apenas visual outline */}
            <Link
              href={`#${TARGET_ID}`}
              prefetch={false}
        ...
        {/* CTA WhatsApp — mobile full width */}
        <a
          href={whatsappHref}
          target="_blank"
          rel="noopener noreferrer"
