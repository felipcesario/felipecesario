...
export default function Intro({
  ...
  const waHref = useMemo(() => {
    ...
    const base = whatsapp.startsWith("+") ? whatsapp : `+55${whatsapp.replace(/\D/g, "")}`;
  ...
  return (
    ...
    >
      ...
      />
      <div className="mx-auto grid max-w-7xl min-h-[88svh] grid-cols-1 items-center gap-8 px-4 py-14 sm:px-6 md:min-h-[88vh] md:grid-cols-2 md:gap-12 md:py-20 lg:gap-14">
